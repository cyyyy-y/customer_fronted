  ...
  <el-container>
    ...
    <el-header>
      <el-row>
        <!--导航栏logo-->
        <el-col :span="3">
          <div class="head1"><img src="../../assets/ht_logo.png"/></div>
        </el-col>
        <!--导航栏 菜单 铃铛 消息-->
        <el-col :span="17">
          <div class="head2">
            <el-col :span="2">
              <div class="head2_1"><img src="../../assets/head_dh.png"/></div>
            </el-col>
            <el-col :span="2">
              <div class="head2_2"><img src="../../assets/head_ring.png"/></div>
            </el-col>
            <el-col :span="18">
              <div class="head2_3">&nbsp</div>
            </el-col>
            <el-col :span="2">
